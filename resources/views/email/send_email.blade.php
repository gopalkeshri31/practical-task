                    ...
                    <tr>
                        <td align="center" valign="top" style="padding: 36px 24px;">
                            <a href="{{route('login')}}" target="_blank" style="display: inline-block;">
                                <img src="{{$details['image']}}" alt="Logo" border="0" width="48"
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">By,<br> Gopal keshri</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef"
                            ...
                            <p style="margin: 0;">Test Email <a href="https://www.linkedin.com/in/gopal-keshri"
                                    target="_blank">By</a> Gopal Keshri.</p>
                        </td>
                    </tr>
                    <!-- end unsubscribe -->
