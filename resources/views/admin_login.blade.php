                ...
                <div class="d-flex align-items-center justify-content-center w-100 z-1 position-relative">
                    <div class="card auth-card mb-0 mx-3">
                        <div class="card-body pt-5">
                            <a href="{{ url('/') }}/main/index.html"
                                class="text-nowrap logo-img text-center d-flex align-items-center justify-content-center mb-5 w-100">
                                <img src="{{ url('/') }}/assets/images/logos/logo-dark.svg" class="light-logo"
                                    alt="Logo-Dark" />
                                <img src="{{ url('/') }}/assets/images/logos/logo-light.svg" class="dark-logo"
                                    alt="Logo-light" />
                            </a>
                            <div class="row">
                                @if (session('error'))
                                ...
                                <div class="col-6 mb-2 mb-sm-0">
                                    <a class="btn btn-white text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-6 shadow-none"
                                        href="{{ route('admin_registration') }}" role="button">

                                        <span class="d-none d-sm-block me-1 flex-shrink-0">Sign Up As</span> Admin
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a class="btn btn-white text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-6 shadow-none"
                                        href="{{ route('customer_registration') }}" role="button">

                                        <span class="d-none d-sm-block me-1 flex-shrink-0">Sign Up As</span> Customer
                                    </a>
                                </div>
                            </div>
                            <div class="position-relative text-center my-4">
                                <p class="mb-0 fs-4 px-3 d-inline-block bg-white text-dark z-1 position-relative">Log in
                                </p>
                                <span
                                    class="border-top w-100 position-absolute top-50 start-50 translate-middle"></span>
                            </div>
                            <form action="{{ route('loginOp') }}" method="post">
                                @csrf
                                <div class="mb-3">
