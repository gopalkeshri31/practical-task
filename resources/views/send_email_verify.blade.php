        ...
        <div class="d-flex align-items-center justify-content-center w-100 z-1 position-relative">
          <div class="card auth-card mb-0 mx-3">
            <div class="card-body pt-5">
              <a href="{{url('/')}}/main/index.html" class="text-nowrap logo-img text-center d-flex align-items-center justify-content-center mb-4 w-100">
                <img src="{{url('/')}}/assets/images/logos/logo-dark.svg" class="light-logo" alt="Logo-Dark" />
                <img src="{{url('/')}}/assets/images/logos/logo-light.svg" class="dark-logo" alt="Logo-light" />
              </a>
              <div class="mb-5 text-center">
                <p>We sent a Emailverification link to your Email. Useing this link to verify your account</p>
                <h6 class="fw-bolder">{{$maskEmailText}}</h6>
              </div>
              <a href="{{route('login')}}"><button  class="btn btn-primary w-100" >back to login</button></a>
            </div>
          </div>
        </div>
        <script>
